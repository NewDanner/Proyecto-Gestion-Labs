...
public class ReportesPanel extends JPanel implements DatabaseChangeListener {
    ...
    JLabel lblZoom = new JLabel("50%"); // Cambiado a 50% inicial
    ...
    try {
        ...
        // Escala inicial cambiada a 0.5f (50%)
        ...
        btnZoomOut.addActionListener(e -> {
            if (scaleHolder[0] > 0.1f) { // Cambiado el límite mínimo a 10%
                scaleHolder[0] -= 0.1f;
                updatePages.run();
            }
        });
        ...
        scrollPane.addMouseWheelListener(e -> {
            if ((e.getModifiersEx() & InputEvent.CTRL_DOWN_MASK) != 0) {
                ...
                e.consume(); // Prevenir el scroll normal
            }
        });
    ...
    btnGuardar.addActionListener(e -> {
        ...
        previewDialog.dispose(); // Cierra la ventana después de guardar
    });
