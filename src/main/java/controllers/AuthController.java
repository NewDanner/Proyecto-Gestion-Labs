...
public class AuthController {
    public User login(String username, String password) {
        String query = "SELECT id_usuario, username, ci, rol, sexo FROM usuarios WHERE username = ? AND password = ? AND estado = TRUE";
    ...
    public boolean register(String username, String password, String ci, String role,String sexo) {
    ...
    public User getUserById(int userId) {
        String query = "SELECT id_usuario, username, ci, rol, sexo FROM Usuarios WHERE id_usuario = ?";
    ...
    String query = "SELECT id_usuario, username, ci, rol, sexo FROM Usuarios WHERE password = ? AND rol = 'Administrador' AND estado = TRUE";
    ...
    try (Connection conn = DatabaseConnection.getConnection();
        ...
        e.printStackTrace();  // Esto muestra si hay error en consola
    }
    return null;
}
