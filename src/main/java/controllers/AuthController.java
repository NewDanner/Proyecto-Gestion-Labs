...
public class AuthController {
    private static final String LOGIN_QUERY = "SELECT id_usuario, nombre, segundo_nombre, primer_apellido, " +
            ...
            "FROM Usuarios WHERE username = ? AND password = ? AND estado = TRUE";
    ...
    private static final String GET_ADMIN_BY_PASSWORD_QUERY = "SELECT id_usuario, nombre, username, ci, rol, sexo " +
...
public boolean updateUserFullWithoutPassword(int userId, String nombre, String segundoNombre, 
    ...
    public boolean register(String nombre, String segundoNombre, String primerApellido,
                      ...
                      String password, String ci, String role, String sexo) {
    ...
    try {
        ...
        String userQuery = "INSERT INTO Usuarios (nombre, segundo_nombre, primer_apellido, " +
                         "segundo_apellido, turno, username, password, ci, rol, sexo, estado) " +
                         "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, TRUE)";
...
private boolean insertarTelefono(String ci, String numero) {
    String query = "INSERT INTO Telefono (ci, numero_telefono) VALUES (?, ?)";
    try (Connection conn = DatabaseConnection.getConnection();
         PreparedStatement stmt = conn.prepareStatement(query)) {
